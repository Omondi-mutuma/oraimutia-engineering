    ...
    <section className="container">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 max-w-7xl mx-auto w-full">
        <WobbleCard containerClassName="col-span-1 lg:col-span-3 lg:min-h-[600px] xl:min-h-[300px] bg-yellow-500">
          <div className="max-w-lg h-full flex flex-col justify-center">
            ...
            <div className="mt-6">
              <CTA
                ...
                variant="btn-filled"
                goto="mailto:sales@oraimutia.co.ke"
              />
            </div>
          </div>
          ...
          <Image
            ...
            className="hidden md:absolute -right-10 md:-right-[40%] lg:-right-[1%] -bottom-10 object-contain rounded-2xl"
          />
        </WobbleCard>
      </div>
    </section>
